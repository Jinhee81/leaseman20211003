...
<?
//sms가 안되어 전화번호인증 생략하고 회원가입하게 함 /21.7.13 화
                    ...
                    <table>
                        ...
                        <thead>
                            <tr>
                                <th>이메일</th>
                                <td>
                                    <input type="email" name="email1" class="onlyeng" placeholder="@포함, 사용하는 이메일 적어주세요"
                                        required>
                            ...
                            <tr>
                                <th>연락처</th>
                                <td>
                                    <input type="number" name="cellphone" id="phone" required
                                        placeholder="'-' 제외, 숫자만 입력합니다" value="">
                                    <input type="hidden" name="phoneAuth" value="no">
                                    <!-- <button type="button" onclick="phone_check();" id="phoneBtn">인증하기</button>
                                            <h1 id="check"></h1>
...
$('#user_div').on('change', function() {
    ...
    if (user_div === "개인") {
        ...
        $('#user_name_div').html(
            "<input type='text' name='user_name' placeholder='사업자명'><input type='text' name='manager_name' placeholder='담당자명'>"
        );
    }
})
