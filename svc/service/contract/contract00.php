...
include $_SERVER['DOCUMENT_ROOT']."/svc/modal/modal_regist.php";//청구번호모달
 ...
 ?>
    ...
    <script src="/svc/inc/js/etc/sms_noneparase.js?<?=date('YmdHis')?>"></script>
    <script src="/svc/inc/js/etc/sms_existparase.js?<?=date('YmdHis')?>"></script>
    ...
    <script src="/svc/inc/js/etc/building3.js?<?=date('YmdHis')?>"></script>
