    ...
    <table class="table table-sm table-hover text-center mt-3">
        ...
        <tr>
            <td class="" name=endDate3>
                ...
                <input type="text" class="form-control form-control-sm dateType text-center" name="enddate33" id="enddate33">
                <input type="hidden" name="rPayid">
            </td>
            <td class="">
                <input type="text" class="form-control form-control-sm amountNumber pink text-right" name="rAmount" numberOnly>
            </td>
            <td class="">
                <input type="text" class="form-control form-control-sm amountNumber pink text-right" name="rvAmount" numberOnly>
            </td>
            <td class="">
                <input type="text" class="form-control form-control-sm amountNumber pink text-right" name="rtAmount" numberOnly>
            </td>
            <td class="" name=rKind>
                <select class="form-control form-control-sm center" id="executiveDiv2">
            ...
            <td class="" name=rDate>
                <input type="text" class="form-control form-control-sm dateType text-center" name="enddate44" id="enddate44">
            </td>
            <td class="mobile" name=textlabel>
            </td>
        </tr>
    </table>
</div>
