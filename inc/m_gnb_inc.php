...
<ul class="gnb_wrap">
    ...
    <li>
        <div class="login_wrap">
            <div class="">
                ...
                <b><a href="../membership/membership4.php">회원가입</a></b>
            </div>
        </div>
    </li>
    <li>
        ...
        <ul class="depth02_list one">
            ...
            <li><a href="../about/leaseman_effect.php">- 리스맨 기능</a></li>
            <li><a href="../about/company_introduction.php">- 회사소개</a></li>
        </ul>
    </li>
    <li>
        <a href="../use_guide/fare_guide.php">요금안내</a>
    ...
    <li>
        <a href="#!">체험하기</a>
        <ul class="depth02_list two">
            <li><a href="../membership/membership4.php">- 체험하기</a></li>
        </ul>
    </li>
    <li>
        <a href="#!">고객센터</a>
